...
public class HashMaps {
	...
	public static void main(String[] args) {
		// 해시맵 - 데이터 저장은 느리지만, 많은 양의 데이터 검색 시 유리
		// 키와 값으로 데이터 저장 - 키는 중복x 값은 중복 허용
		...
		System.out.println("key 23 : " + hmap1.get(23));
		System.out.println("key 49 : " + hmap1.get(49));
		// 특정키로 검색하기

		System.out.println("key 11 : " + hmap1.get(11));
		hmap1.remove(11);
		System.out.println("key 11 : " + hmap1.get(11));
		...
		SungJukVO sj2 = new SungJukVO("지현", 54, 68, 76);
		SungJukVO sj3 = new SungJukVO("수지", 78, 88, 95);
		SungJukVO sj4 = new SungJukVO("중기", 98, 99, 100);
