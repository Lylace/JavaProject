...
public class FileOutputStreams {
	...
	public static void main(String[] args) {
		...
		String name = "지현";
		Users u = new Users("zzyzzy", "123456", "혜교", 33);
		int age = 31;

		String fpath = "c:/java/data.dat";
...
// 클래스를 직렬화해서 파일에 저장하려면 해당 클래스는 Serializable 인터페이스를 구현해야 함

class Users implements Serializable {
	private static final long serialVersionUID = -3125950042129786915L;
	String userid;
	String passwd;
	String name;
	int age;
